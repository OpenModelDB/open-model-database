        ...
        <div className="relative w-full">
            ...
            >
                ...
                {(!readonly || images.length > 1) && (
                    ...
                    // Sits inside the stage card so it reads as the image's controls
                    // rather than as a detached row floating below it.
                    <div className="flex w-full flex-wrap items-center justify-center gap-2 border-x-0 border-b-0 border-t border-solid border-line py-3 sm:gap-3">
                        {images.length >= 2 && (
                            <button
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <img
                                                ...
                                                src={
                                                    image.thumbnail || (image.type === 'paired' ? image.LR : image.url)
                                                }
                                                title={image.caption}
                                            />
                                        </div>
