...
export type LicensePermission = 'commercial-use' | 'modifications' | 'private-use' | 'patent-use' | 'distribution';
...
const KNOWN_LICENSES_: Record<string, LicenseProperties> = {
    'Apache-2.0': {
        ...
        permissions: ['commercial-use', 'distribution', 'modifications', 'private-use', 'patent-use'],
    ...
    'CC-BY-NC-4.0': {
        ...
        permissions: ['distribution', 'modifications', 'private-use'],
        conditions: ['include-copyright', 'state-changes'],
        limitations: ['liability', 'trademark-use', 'warranty', 'patent-use'],
    },
    'CC-BY-NC-SA-4.0': {
